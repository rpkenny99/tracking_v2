...
class FeedbackUI(QMainWindow):
    ...
    def take_screenshot(self):
        ...
        if screen:
            ...
            # Create directory "UI_Screenshots" in the current working directory if it doesn't exist
            screenshot_dir = os.path.join(os.getcwd(), "UI_Screenshots")
            if not os.path.exists(screenshot_dir):
                os.makedirs(screenshot_dir)
            
            # Use update_count in the filename so each screenshot is unique.
            filename = os.path.join(screenshot_dir, f"screenshot_{self.update_count}.png")
            screenshot.save(filename, "png")
            print(f"Screenshot saved as {filename}")
            
            # Maintain only the 10 most recent screenshots
            ...
            while len(files) > 10:
                ...
                print(f"Removed old screenshot: {file_to_remove}")   
    ...
    def _updateData(self):
        ...
        self.take_screenshot() #Toni Added 2
