...
def get_mean_std_bounds():
    ...
    folder_path = "Capstone/SignalProcessing/expert_data/"
    file_list = [f"{folder_path}filtered_data_{i}.txt" for i in range(1, 7)]
    return compute_statistics_spatial(file_list)

def plot_trajectories(mean_traj, upper_bound, lower_bound):
...
if __name__ == "__main__":
    ...
    plot_trajectories(mean_traj, upper_bound, lower_bound)
